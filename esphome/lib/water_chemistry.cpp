...
float WaterChemistry::calculate_acid_needed_ml(AcidType acid_type,
...
float WaterChemistry::get_acid_equivalent_factor(AcidType acid_type) {
  switch (acid_type) {
...
float WaterChemistry::get_acid_molar_mass(AcidType acid_type) {
  switch (acid_type) {
    case AcidType::SULFURIC_ACID_14_9_PERCENT:
      return 98.079f;
    default:
...
float WaterChemistry::get_acid_density(AcidType acid_type) {
  switch (acid_type) {
    case AcidType::SULFURIC_ACID_14_9_PERCENT:
      return 1.1013f;
    default:
...
float WaterChemistry::get_acid_concentration(AcidType acid_type) {
  switch (acid_type) {
    case AcidType::SULFURIC_ACID_14_9_PERCENT:
      return 0.149f;
    default:
